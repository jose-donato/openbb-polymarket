					...
					>
						...
						<div class="bg-gray-800 rounded-lg p-6 w-full max-w-2xl">
							<h2 class="text-lg font-semibold text-white mb-4">
								How to Add to OpenBB Workspace
							</h2>
							<ol class="list-decimal list-inside space-y-2 text-sm text-gray-300">
								<li>
									Log in to your OpenBB account at{" "}
									<a
								...
								<li>
									Navigate to the <strong>Apps</strong> page
								</li>
								<li>
									Click the <strong>Connect backend</strong> button
								</li>
								<li>
									...
									<ul class="list-disc list-inside ml-4 mt-1 space-y-1">
										...
										<li>
											...
											<span class="inline-flex items-center gap-2">
												<code class="ml-1 bg-gray-700 text-gray-200 px-1 py-0.5 rounded">
								...
								<li>
									If the test is successful, click <strong>Add</strong>
								</li>
							</ol>
							<p class="text-sm text-gray-300 mt-4">
								Once added, you'll find Polymarket app available in the Apps
								section of OpenBB Workspace. All the widgets will also be
								available in search to add to your dashboards.
							</p>
						</div>

						<div class="flex justify-center mt-6">
							<a
								href="https://github.com/jose-donato/openbb-polymarket"
								target="_blank"
								rel="noopener noreferrer"
								class="inline-flex items-center gap-2 px-6 py-3 bg-white text-gray-900 font-semibold rounded-lg hover:bg-gray-100 transition-colors duration-200 shadow-lg hover:shadow-xl"
							>
...
app.get("/widgets.json", (c) => {
	return c.json({
			...
			params: [
				{
					paramName: "id",
					description:
						"The id of the event to get price history for all markets",
					type: "number",
					value: 19694,
				},
			],
		...
		home_cards: {
			name: "Home Cards",
			description:
				"Get featured events for the home page on Polymarket (ordered by 24hr volume)",
			source: "Polymarket",
		...
		user_positions: {
			name: "User Positions",
			description: "Get trading positions for a specific user on Polymarket",
			source: "Polymarket",
			endpoint: "/polymarket/user_positions",
			params: [
				{
					paramName: "user",
					description: "The wallet address of the user to get positions for",
					type: "text",
					value: "0x75049bd489194be19c45c31ed311e556411c9c69",
				},
			],
			data: {
				table: {
